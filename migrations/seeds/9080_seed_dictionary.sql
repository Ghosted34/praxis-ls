...
INSERT INTO _dict_seed (direction,key,label_fr,label_en,subcategory,applicability_mode,unit_of_measure,is_billable,proof_source,receipt_requirement,requires_justification,vat,account,svc,tier_default,legacy_codes) SELECT 'REVENUE', * FROM (VALUES
 ...
 ('RAIL_FREIGHT','Fret ferroviaire','Rail Freight','TRUCKING','SERVICE_SCOPED',NULL,true,'INTERNAL_SERVICE','ALWAYS_REQUIRED',true,'STD','7061','{RAIL_TRANSPORTATION,RAIL_HINTERLAND_TRANSIT,END_TO_END_RAIL_FREIGHT}'::text[],'BASIC',NULL),
...
INSERT INTO _dict_seed (direction,key,label_fr,label_en,subcategory,applicability_mode,unit_of_measure,is_billable,proof_source,receipt_requirement,requires_justification,vat,account,svc,tier_default,legacy_codes) SELECT 'EXPENSE', * FROM (VALUES
 ...
 ('WAGON_DEMURRAGE','Immobilisation / Surestaries wagon','Wagon Demurrage','DEMURRAGE_DETENTION','SERVICE_SCOPED','DAY',true,'THIRD_PARTY_VENDOR','ALWAYS_REQUIRED',true,'STD','6222','{RAIL_TRANSPORTATION,RAIL_HINTERLAND_TRANSIT}'::text[],'ADVANCED',NULL),
 ('RAIL_ESCORT_FEE','Escorte et sécurité ferroviaire','Rail Escort & Security Fee','ESCORT','SERVICE_SCOPED','UNIT',true,'THIRD_PARTY_VENDOR','ALWAYS_REQUIRED',true,'STD','6271','{RAIL_TRANSPORTATION,RAIL_HINTERLAND_TRANSIT}'::text[],'ADVANCED',NULL),
