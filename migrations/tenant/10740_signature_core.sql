-- ============================================================================
-- TENANT DB — 10740 Signature core: reshape document_signature into the table
...
--      The product still says "Tier 1..4" out loud; signature_preset (10741)
...
BEGIN
  IF EXISTS (
    ...
    IF n > 0 THEN
      RAISE EXCEPTION
        'document_signature holds % row(s) from the 0410 stub. Migrate or archive them before running 10740 — see doc/SIGNATURE_ENGINEERING_GUIDE.md §4.2.', n;
    END IF;
  END IF;
END $$;
