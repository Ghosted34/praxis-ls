...
module.exports = {
  ...
  reads: [
    ...
    { key: "client_portal_view", service: (c, p) => service.clientView(c, { clientId: p.client_id }), permission: { module: "MOD-29", action: "view" }, describe: "A client's scoped view: their dossiers, invoices, receivables ageing." },
