...
module.exports = {
  ...
  writes: [
    ...
    { key: "transition_lead", service: (c, p, actor) => service.transition(c, { id: p.lead_id, to: p.to, actor }), schema: validator.schemas.aiTransition, permission: { module: "MOD-20", action: "edit" }, confirm: true, describe: "Advance a lead by id to CONTACTED/QUALIFIED/LOST." },
    { key: "convert_lead", service: (c, p, actor) => service.convert(c, { id: p.lead_id, clientData: p.client, actor }), schema: validator.schemas.aiConvert, permission: { module: "MOD-20", action: "edit" }, confirm: true, describe: "Convert a qualified lead (by id) into a client. The `client` block MUST carry client_type and payment_terms_days — the legacy's silent fallback to BOTH/30 is gone." },
  ],
};
