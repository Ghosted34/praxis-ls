...
const create = z.object({
  ...
  lines: z.array(z.object({ item: z.string().min(1), ordered: z.number().nonnegative().optional(), received: z.number().nonnegative().optional(), condition: z.string().optional() })).optional(),
});
const qa = z.object({
