...
const COUNTRIES = [
  ...
  { code: "BQ", name: "Bonaire, Sint Eustatius and Saba", phone: "599", currency: "USD" },
  ...
  { code: "CD", name: "Congo (Democratic Republic)", phone: "243", currency: "CDF" },
  { code: "CF", name: "Central African Republic", phone: "236", currency: "XAF" },
  ...
  { code: "GS", name: "South Georgia and the South Sandwich Islands", phone: "500", currency: "GBP" },
  ...
  { code: "HM", name: "Heard Island and McDonald Islands", phone: "672", currency: "AUD" },
  ...
  { code: "IO", name: "British Indian Ocean Territory", phone: "246", currency: "USD" },
  ...
  { code: "MF", name: "Saint Martin (French part)", phone: "590", currency: "EUR" },
  ...
  { code: "MP", name: "Northern Mariana Islands", phone: "1670", currency: "USD" },
  ...
  { code: "PM", name: "Saint Pierre and Miquelon", phone: "508", currency: "EUR" },
  ...
  { code: "SX", name: "Sint Maarten (Dutch part)", phone: "1721", currency: "ANG" },
  { code: "SY", name: "Syria", phone: "963", currency: "SYP" },
  { code: "SZ", name: "Eswatini", phone: "268", currency: "SZL" },
  { code: "TC", name: "Turks and Caicos Islands", phone: "1649", currency: "USD" },
  { code: "TD", name: "Chad", phone: "235", currency: "XAF" },
  { code: "TF", name: "French Southern Territories", phone: "262", currency: "EUR" },
  ...
  { code: "UM", name: "United States Minor Outlying Islands", phone: "1", currency: "USD" },
  ...
  { code: "VC", name: "Saint Vincent and the Grenadines", phone: "1784", currency: "XCD" },
  { code: "VE", name: "Venezuela", phone: "58", currency: "VES" },
  { code: "VG", name: "Virgin Islands (British)", phone: "1284", currency: "USD" },
...
const OHADA = [
  ...CEMAC,
  "BJ", "BF", "CI", "KM", "CD", "GW", "GN", "ML", "NE", "SN", "TG",
];
 ...
 */
const MAJOR_LANES = [
  "CN", "US", "FR", "NL", "BE", "DE", "GB", "AE", "IN", "ZA", "NG", "GH",
  "TR", "IT", "ES", "SG", "HK", "JP", "KR", "BR", "MA", "EG",
];
...
const OHADA_REQUIREMENTS = [
  { kind: "NIU", label_fr: "Numéro d'Identifiant Unique", label_en: "Unique Taxpayer Number", regex: "^[A-Za-z0-9]{8,20}$", placeholder: "P0123456789A", required: true },
  { kind: "RCCM", label_fr: "Registre du Commerce et du Crédit Mobilier", label_en: "Trade & Personal Property Credit Register", regex: "^[A-Za-z0-9/\\-]{6,30}$", placeholder: "RC/DLA/2020/B/1234", required: true },
];
const EU_REQUIREMENTS = [
  { kind: "VAT", label_fr: "Numéro de TVA intracommunautaire", label_en: "VAT number", regex: "^[A-Za-z]{2}[A-Za-z0-9]{2,12}$", placeholder: "FR12345678901", required: true },
  { kind: "EORI", label_fr: "Numéro EORI", label_en: "EORI number", regex: "^[A-Za-z]{2}[A-Za-z0-9]{1,15}$", placeholder: "FR123456789012345", required: false },
];
const REGISTRATION_REQUIREMENTS = {
  US: [
    { kind: "EIN", label_fr: "Employer Identification Number", label_en: "Employer Identification Number (EIN)", regex: "^\\d{2}-?\\d{7}$", placeholder: "12-3456789", required: true },
    { kind: "W9", label_fr: "Formulaire W-9", label_en: "Form W-9", regex: "", placeholder: "On file", required: false },
  ],
  GB: [
    { kind: "CRN", label_fr: "Companies House Number", label_en: "Companies House Number", regex: "^[A-Za-z0-9]{8}$", placeholder: "01234567", required: true },
    { kind: "VAT", label_fr: "Numéro de TVA", label_en: "VAT number", regex: "^GB[0-9]{9,12}$", placeholder: "GB123456789", required: false },
    { kind: "UTR", label_fr: "Unique Taxpayer Reference", label_en: "Unique Taxpayer Reference (UTR)", regex: "^\\d{10}$", placeholder: "1234567890", required: false },
  ],
};
...
const CATALOGUE = COUNTRIES
  .map((c) => ({ ...c, sort_order: sortOrder(c.code) }))
