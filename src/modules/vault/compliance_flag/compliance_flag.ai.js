...
module.exports = {
  ...
  reads: [
    { key: "list_compliance_flags", service: (c, p) => service.list(c, p), permission: { module: "MOD-65", action: "view" }, describe: "Open compliance flags (missing proofs, unmatched procurement, aged régie, débours tax)." },
