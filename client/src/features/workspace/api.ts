...
/** One stage of the linked file's chain, as a task read carries it (13930). */
...
export type Task = {
  ...
  /** Every stage of the file's chain the task is on, in chain order (13930).
...
export type TaskInput = {
   ...
   *  (13930). Replaces the whole set; [] clears it. Wins over the single id. */
  milestone_instance_ids?: string[];
  is_personal?: boolean;
  reminder_minutes?: number | null;
  remind_at?: string | null;
