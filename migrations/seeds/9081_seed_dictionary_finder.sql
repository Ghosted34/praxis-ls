...
INSERT INTO _fd_amend (code,old_fr,new_fr,old_en,new_en,old_sub,new_sub,descr,keywords,legacy_ref) VALUES
 ...
 ('#R022','Fret ferroviaire',NULL,'Rail Freight',NULL,'RAIL',NULL,'Prestation de transport ferroviaire de marchandises. Rail freight carriage service.',ARRAY['camrail','ferroviaire','fret','rail','rail freight','train','wagon']::text[],NULL),
 ('#R023','Frais de manœuvre et gare',NULL,'Rail Shunting & Station Fee',NULL,'HANDLING',NULL,'Frais de manœuvre ferroviaire, mise à quai et gare. Rail shunting, siding and railhead station handling.',ARRAY['embranchement','gare','manoeuvre','rail','shunting','siding','voie']::text[],NULL),
 ('#R024','Manutention terminal ferroviaire',NULL,'Railhead Terminal Handling',NULL,'HANDLING',NULL,'Manutention et transbordement en terminal ferroviaire. Handling and transhipment at rail terminal.',ARRAY['acconage','gare','manutention','railhead','terminal ferroviaire','transbordement']::text[],NULL),
 ('#E045','Immobilisation / Surestaries wagon',NULL,'Wagon Demurrage',NULL,'DEMURRAGE',NULL,'Frais d''immobilisation et surestaries de wagon ferroviaire. Demurrage and detention charges for rail wagons.',ARRAY['demurrage','detention','gare','immobilisation','surestaries','wagon']::text[],NULL),
 ('#E046','Escorte et sécurité ferroviaire',NULL,'Rail Escort & Security Fee',NULL,'ESCORT',NULL,'Frais de sécurité et escorte de convoi ferroviaire. Escort and security services for rail freight convoys.',ARRAY['convoi','escorte','gardiennage','rail escort','securite','train']::text[],NULL),
 ('#D147','Redevance corridor ferroviaire',NULL,'Rail Corridor Levy',NULL,'DECLARATION',NULL,'Redevance et taxe de corridor ferroviaire international. International rail transit corridor levy.',ARRAY['corridor','declaration','redevance','taxe','transit ferroviaire']::text[],NULL)
