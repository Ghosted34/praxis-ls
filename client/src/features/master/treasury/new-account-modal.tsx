...
export function NewAccountModal({
  ...
  React.useEffect(() => {
    ...
    api
      .listCategories()
      .then((rows) => setCats(rows.filter((c) => c.is_active)));
  }, [open]);
  ...
  return (
    <>
      <Modal
        ...
        description="A bank, cash, petty-cash or mobile-money account. The CoA leaf is minted automatically under the category's parent."
      >
