...
export function AssetsPage() {
  ...
  const columns: Column<Asset>[] = [
    { key: "label", label: "Asset", render: (r) => <span className="font-medium text-foreground">{smartCell(r.label)}</span> },
    { key: "tag", label: "Tag", render: (r) => <span className="num">{smartCell(r.tag ?? "—")}</span> },
