...
module.exports = {
  ...
  reads: [
    { key: "list_delivery_notes", service: service.list, describe: "List delivery notes. Filter by dossier_id, status (CSV) or q (number, file ref, consignee, who signed)." },
    { key: "get_delivery_note", service: service.get, describe: "Get a delivery note with its cargo lines, containers and allowed transitions." },
    { key: "delivery_note_summary", service: service.summary, describe: "Count delivery notes by status, for the KPI tiles." },
  ],
  writes: [
