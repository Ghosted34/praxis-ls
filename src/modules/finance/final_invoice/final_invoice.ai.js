...
module.exports = {
  ...
  writes: [
    ...
    { key: "submit_final_invoice", service: (c, p, actor) => service.submit(c, { invoiceId: p.invoice_id, entryDate: p.entry_date, sourceDocRef: p.source_doc_ref, actor }), schema: validator.schemas.aiSubmit, permission: { module: "MOD-51", action: "approve" }, confirm: true, describe: "Submit a final invoice by id; auto-posts (revenue+débours+VAT, clears advance, numbers + captures the doc) when no workflow is bound. KB §8.3." },
  ],
};
