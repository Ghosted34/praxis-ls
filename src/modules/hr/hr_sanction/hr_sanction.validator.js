...
const aiUpdate = update.extend({ hr_sanction_id: z.string().uuid() });
const aiLift = z.object({ hr_sanction_id: z.string().uuid() });
const schemas = { create, update, aiUpdate, aiLift };
