...
module.exports = {
  ...
  reads: [
    { key: "list_reports", service: () => service.catalogue(), permission: { module: "MOD-63", action: "view" }, describe: "List available reports (income statement, receivables ageing, cash position, dossier margin, procurement spend, …)." },
