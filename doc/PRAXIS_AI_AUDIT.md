...
| PR 6 | Conversation management & Spaces UX (J1–J5) | 🟡 awaiting merge | All five in [#428](https://github.com/tomblakeasaah196/praxis-ls/pull/428): migration `13920` (`deleted_at`/`archived_at`/`pinned_at` on `ai_conversation`), `PATCH`/`DELETE /ai/conversations/:id`, the per-row overflow menu and the collapsible Spaces section. Flip to ✅ on merge. |
