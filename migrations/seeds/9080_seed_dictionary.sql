...
INSERT INTO _dict_seed (direction,key,label_fr,label_en,subcategory,applicability_mode,unit_of_measure,is_billable,proof_source,receipt_requirement,requires_justification,vat,account,svc,tier_default,legacy_codes) SELECT 'REVENUE', * FROM (VALUES
 ...
 ('RAIL_FREIGHT','Fret ferroviaire','Rail Freight','TRUCKING','SERVICE_SCOPED',NULL,true,'INTERNAL_SERVICE','ALWAYS_REQUIRED',true,'STD','7061','{RAIL_TRANSPORTATION,RAIL_HINTERLAND_TRANSIT}'::text[],'BASIC',NULL),
 ('RAIL_SHUNTING_FEE','Frais de manœuvre et gare','Rail Shunting & Station Fee','HANDLING','SERVICE_SCOPED',NULL,true,'INTERNAL_SERVICE','ALWAYS_REQUIRED',true,'STD','7061','{RAIL_TRANSPORTATION,RAIL_HINTERLAND_TRANSIT}'::text[],'ADVANCED',NULL),
 ('RAIL_TERMINAL_HANDLING','Manutention terminal ferroviaire','Railhead Terminal Handling','HANDLING','SERVICE_SCOPED',NULL,true,'INTERNAL_SERVICE','ALWAYS_REQUIRED',true,'STD','7061','{RAIL_TRANSPORTATION,RAIL_HINTERLAND_TRANSIT}'::text[],'BASIC',NULL),
