...
module.exports = {
  ...
  reads: [{ key: "reconcile_dossier", service: service.reconcileDossier, permission: { module: "MOD-47", action: "view" }, describe: "Budget vs actual reconciliation for a dossier (MOD-48)." }],
