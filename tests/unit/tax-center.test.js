...
const {
  ...
  cnpsSummary,
  dsfDataset,
} = require("../../src/modules/finance/tax_declaration/tax_declaration.rules");
const {
  incomeStatement,
  balanceSheet,
...
describe("VAT return (§16)", () => {
  ...
  it("net credit carried forward when input exceeds output", () => {
    const r = vatReturn([
      { account_code: "4432", debit: 0, credit: 100000 },
      { account_code: "445", debit: 150000, credit: 0 },
    ]);
    ...
    const items = [
      {
        ...
        gross: 500000,
        breakdown: {
          employee: { cnps_pension: 21000 },
          employer: { pension: 21000, family: 35000, injury: 8750 },
        },
      },
      {
        employee_name: "B",
        ...
        gross: 900000,
        breakdown: {
          employee: { cnps_pension: 31500 },
          employer: { pension: 31500, family: 52500, injury: 15750 },
        },
      },
    ];
