...
module.exports = {
  ...
  reads: [
    { key: "list_pricing_variance", service: (c, p) => service.listSales(c, p), permission: { module: "MOD-27", action: "view" }, describe: "Sales pricing-variance list (R/Y/G flag + quote; never raw cost)." },
    { key: "get_pricing_variance", service: (c, p) => service.getSales(c, p.id || p), permission: { module: "MOD-27", action: "view" }, describe: "One pricing-variance entry, Sales view (no cost)." },
  ],
  writes: [
