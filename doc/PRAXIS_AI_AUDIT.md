...
| PR 6 | Conversation management & Spaces UX (J1–J5) | 🟡 in progress | All five built on `claude/clever-feynman-ov6ad3`: migration `13920` (`deleted_at`/`archived_at`/`pinned_at` on `ai_conversation`), `PATCH`/`DELETE /ai/conversations/:id`, the per-row overflow menu and the collapsible Spaces section. Flip to ✅ and link the PR on merge. |
...
### PR 6 — Conversation management & Spaces UX (closes J1, J2, J3, J4, J5) · **P1** — 🟡 built, awaiting merge (`claude/clever-feynman-ov6ad3`)
