...
module.exports = {
  ...
  writes: [
    ...
    { key: "update_user", service: (c, p, actor) => (({ user_id, ...patch }) => service.updateUser(c, { id: user_id, patch, actor }))(p), schema: validator.schemas.aiUpdate, permission: { module: "MOD-67", action: "edit" }, confirm: true, describe: "Update a user's profile/roles by id." },
    { key: "set_user_status", service: (c, p, actor) => service.setStatus(c, { id: p.user_id, status: p.status, actor }), schema: validator.schemas.aiStatus, permission: { module: "MOD-67", action: "edit" }, confirm: true, describe: "Activate/suspend/lock a user by id (guards last CEO)." },
  ],
};
