...
module.exports = {
  ...
  writes: [
    ...
    { key: "transition_cash_request", service: (c, p) => service.transition(c, { id: p.cash_request_id, to: p.to, entityId: p.entity_id, date: p.date }), schema: validator.schemas.aiTransition, permission: { module: "MOD-49", action: "approve" }, confirm: true, describe: "Submit/approve/reject a cash request by id." },
