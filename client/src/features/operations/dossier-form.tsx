      ...
      <form className="space-y-5" onSubmit={submit}>
        ...
        {switched && (
          <Callout tone="warn" title="Service type changed">
            The details below belong to the new service type. Anything captured
            under the previous one has been cleared — a warehouse location has
            no meaning on a sea file.
          </Callout>
        )}
